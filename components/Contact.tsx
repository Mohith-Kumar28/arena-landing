        ...
        <form className="max-w-2xl space-y-8 relative z-10 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input type="text" placeholder="Your Name" className="w-full bg-[#494C72]/20 border border-[#494C72] rounded-lg px-4 py-3.5 text-text-main focus:outline-none focus:border-primary-blue transition-colors placeholder:text-gray-500" />
            </div>
             <div className="space-y-2">
              <label className="text-sm font-semibold text-text-main">Email ID*</label>
              <input type="email" placeholder="Your Email ID" className="w-full bg-[#494C72]/20 border border-[#494C72] rounded-lg px-4 py-3.5 text-text-main focus:outline-none focus:border-primary-blue transition-colors placeholder:text-gray-500" />
            </div>
             <div className="space-y-2">
              <label className="text-sm font-semibold text-text-main">Mobile*</label>
              <input type="text" placeholder="Your Mobile Number" className="w-full bg-[#494C72]/20 border border-[#494C72] rounded-lg px-4 py-3.5 text-text-main focus:outline-none focus:border-primary-blue transition-colors placeholder:text-gray-500" />
            </div>
             <div className="space-y-2">
              <label className="text-sm font-semibold text-text-main">Company Name*</label>
              <input type="text" placeholder="Your Company Name" className="w-full bg-[#494C72]/20 border border-[#494C72] rounded-lg px-4 py-3.5 text-text-main focus:outline-none focus:border-primary-blue transition-colors placeholder:text-gray-500" />
            </div>
          </div>

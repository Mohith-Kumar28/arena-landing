...
export default function Button({ 
  ...
  const variants = {
    primary: "bg-black border border-l-[0.5px] border-t-[0.5px] border-r-[3px] border-b-[3px] border-primary-blue text-text-main shadow-[2px_2px_10px_rgba(56,189,248,0.2)] hover:shadow-[2px_2px_15px_rgba(56,189,248,0.4)] active:scale-95",

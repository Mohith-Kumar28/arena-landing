    ...
    <footer className="bg-background-main py-52 px-8 md:px-24 lg:px-32 relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 max-w-7xl mx-auto w-full">
        ...
        <div className="md:col-span-4 flex flex-col justify-between h-full">
            ...
            <p className="text-text-main font-manrope text-sm mt-auto">© Copyright Arena 2026</p>
        </div>

        {/* Links Column 1: Arena */}
        <div className="md:col-span-2 md:col-start-7 flex flex-col gap-6 items-end text-right">
        ...
        <div className="md:col-span-2 flex flex-col gap-6 items-end text-right">
             <h3 className="text-text-main font-bebas text-[24px] mb-2 tracking-wide">Information</h3>
             <div className="flex flex-col gap-3">
                <Link href="#" className="text-gray-400 hover:text-text-main transition-colors font-manrope font-normal text-[20px]">Sign In</Link>
                <Link href="#" className="text-gray-400 hover:text-text-main transition-colors font-manrope font-normal text-[20px]">Activate License</Link>
                <Link href="#" className="text-gray-400 hover:text-text-main transition-colors font-manrope font-normal text-[20px]">FAQ</Link>
             </div>
        </div>
